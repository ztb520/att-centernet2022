...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='fiveclass',
                             help='coco | kitti | coco_hp | pascal | moreclass | car | threeclass | twoclass | person | fiveclass')
    ...
    # model
    self.parser.add_argument('--arch', default='attres_18',
                             help='model architecture. Currently tested'
                                  'res_18 | attres_18 | res_101 | resdcn_18 | resdcn_101 |'
  ...
  def init(self, args=''):
    default_dataset_info = {
      'ctdet': {'default_resolution': [512, 512], 'num_classes': 5,
                'mean': [0.46391997, 0.42355588, 0.38096455], 'std': [0.2509655, 0.24774177, 0.24929404],
                'dataset': 'fiveclass'},
